                            ...
                            <div class="card-body">
                                ...
                                <table class="table table-striped">
                                    <tbody>
                                        ...
                                        <tr>  <td>Order</td><td><?=$row['order_number']?></td></tr>
                                        <tr>   <td>Date</td><td><?=$row['date']?></td></tr>
                                        <tr>   <td>Qty</td><td><?=$row['qty']?></td></tr>
                                        <tr>   <td>Total</td><td><?=$row['total_price']?></td></tr>
                                        <tr>   <td>Costumer</td><td><?=$row['customer_id']?></td></tr>
                                        <tr>   <td>Product</td><td><?=$row['product_id']?></td></tr>
